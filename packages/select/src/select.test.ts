...
import {WcSelect} from './select/old.select.component'
import './index'

const getSelect = () => document.querySelector('#single') as WcSelect
const getSelectMultiply = () => document.querySelector('#multiply') as WcSelect
