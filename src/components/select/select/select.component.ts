import {getEventDataset} from '@kai/utils'
...
export class LitSelect extends focusable(labled(stylable(definable(LitFormAssoc), selectCSSVars, PREFIX))) implements IPropsSelect{
    static styles = [
        ...super.styles, 
        css`
        :host{
    ...
    /** @ignore */
    #wrapperTemplate(){
        return this.#containerTemplate(html`
