...
import type {FormAssociatedElement} from '../../mixins/form-associated/types'

import {defaultValidationMessages, defaultValidity} from './consts'
import {styles} from './styles'
import {TValidationMessageKey, TValidationMessages} from './types'
...
export class LitFormAssoc extends LitElement implements FormAssociatedElement {
    ...
    set min(value: number | undefined){this.#min = value}

    /** @ignore */
    #max?: number
    get max(){return this.#max}
    set max(value: number | undefined){this.#max = value}

    /** @ignore */
    
    #step?: number
    get step(){return this.#step}
    set step(value: number | undefined){this.#step = value}
