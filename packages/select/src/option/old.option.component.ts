...
import type {WcSelect} from '../select/old.select.component'
...
export class LitOption extends focusable(stylable(definable(LitElement), selectCSSVarsMap, SELECT_PREFIX)) {
  static styles = css`
    :host {
      display: block;
  ...
  private _selectHost: WcSelect | null = null

  public setSelectHost(host: WcSelect) {
