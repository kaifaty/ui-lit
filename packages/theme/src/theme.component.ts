import {lch2rgb} from '@kaifat/utils'
    ...
    return [
      css`
        :host([theme='light']) {
          ...
          ${LitText.cssKey(
            'color-attention',
          )}: hsl(38, calc(90% + var(--s) * 0.2), calc(75% + var(--l) * 0.1));
          ...
          ${LitCheckbox.cssKey('checkbox-background')}: var(--primary--700);
          ${LitCheckbox.cssKey('checkbox-border')}: 2px solid var(--primary--1000);
          ${LitCheckbox.cssKey('checkmark-color')}: var(--primary-1250);
          ${LitCheckbox.cssKey('checkmark-shadow-hover')}: 0 0 5px var(--primary-400);
          ${LitCheckbox.cssKey('switcher-control-background')}: var(--primary--700);
          ${LitCheckbox.cssKey('switcher-control-shadow')}: 1px 1px 5px var(--primary-900);
          ...
          ${LitMarkdown.cssKey('background')}: hsl(var(--primary-h), 3%, 10%);
          ${LitMarkdown.cssKey('background-code')}: hsl(var(--primary-h), 3%, 90%);
          ${LitMarkdown.cssKey('background-color-subtle')}: hsl(var(--primary-h), 3%, 95%);
          ${LitMarkdown.cssKey('border-default')}: hsl(var(--primary-h), 20%, 77%);
          ${LitMarkdown.cssKey('border-muted')}: hsl(var(--primary-h), 20%, 88%);
          ${LitMarkdown.cssKey('box-shadow')}: hsla(var(--primary-h), 5%, 5%, 0.2);
          ${LitMarkdown.cssKey('color')}: hsl(var(--primary-h), 3%, 80%);
          ${LitMarkdown.cssKey('color-blockquote')}: hsl(var(--primary-h), 90%, 60%);
          ${LitMarkdown.cssKey('color-lang')}: hsl(var(--primary-h), 98%, 85%);
          ${LitMarkdown.cssKey('color-line-counter')}: hsl(var(--primary-h), 3%, 40%);
          ${LitMarkdown.cssKey('color-link')}: hsl(211, 98%, 55%);
          ${LitMarkdown.cssKey('color-muted')}: hsl(var(--primary-h), 3%, 50%);
      ...
      css`
        :host([theme='dark']) {
          ...
          ${LitText.cssKey(
            'color-attention',
          )}: hsl(38, calc(90% + var(--s) * 0.2), calc(55% + var(--l) * 0.1));
          ...
          ${LitCheckbox.cssKey('checkbox-background')}: var(--primary-1300);
          ${LitCheckbox.cssKey('checkbox-border')}: 2px solid var(--primary-800);
          ${LitCheckbox.cssKey('checkmark-color')}: var(--primary--650);
          ${LitCheckbox.cssKey('checkmark-shadow-hover')}: 0 0 5px var(--primary-800);
          ${LitCheckbox.cssKey('switcher-control-background')}: var(--primary--700);
          ${LitCheckbox.cssKey('switcher-control-shadow')}: 1px 1px 5px var(--primary-1300);
          ...
          ${LitMarkdown.cssKey('background')}: hsl(var(--primary-h), 22%, 2%);
          ${LitMarkdown.cssKey('background-code')}: hsl(var(--primary-h), 22%, 11%);
          ${LitMarkdown.cssKey('background-color-subtle')}: hsl(var(--primary-h), 25%, 7%);
          ${LitMarkdown.cssKey('border-default')}: hsl(var(--primary-h), 20%, 19%);
          ${LitMarkdown.cssKey('border-muted')}: hsl(var(--primary-h), 20%, 14%);
          ${LitMarkdown.cssKey('box-shadow')}: hsla(var(--primary-h), 5%, 5%, 0.2);
          ${LitMarkdown.cssKey('color')}: hsl(var(--primary-h), 3%, 80%);
          ${LitMarkdown.cssKey('color-blockquote')}: hsl(var(--primary-h), 98%, 80%);
          ${LitMarkdown.cssKey('color-lang')}: hsl(var(--primary-h), 98%, 80%);
          ${LitMarkdown.cssKey('color-line-counter')}: hsl(var(--primary-h), 3%, 20%);
          ${LitMarkdown.cssKey('color-link')}: hsl(211, 98%, 67%);
          ${LitMarkdown.cssKey('color-muted')}: hsl(var(--primary-h), 3%, 50%);
  ...
  willUpdate(_changedProperties: Map<string | number | symbol, unknown>): void {
    if (_changedProperties.has('theme')) {
      document.dispatchEvent(
        new CustomEvent('themeHasChanged', {
          detail: this.theme,
        }),
      )
    }
